...
def create_generator_reg(input_dim, noise_dim, l2_alpha):
    generator = tf.keras.Sequential([
        Dense(128, activation='relu', input_shape=(noise_dim,), kernel_regularizer=l2(l2_alpha)),
        BatchNormalization(),
        Dropout(0.3),
        Dense(256, activation='relu', kernel_regularizer=l2(l2_alpha)),
        BatchNormalization(),
        Dropout(0.3),
        Dense(512, activation='relu', kernel_regularizer=l2(l2_alpha)),
        BatchNormalization(),
        Dropout(0.3),
        Dense(input_dim, activation='sigmoid')
    ])
...
def create_discriminator_reg(input_dim, l2_alpha):
    discriminator = tf.keras.Sequential([
        Dense(512, activation='relu', kernel_regularizer=l2(l2_alpha), input_shape=(input_dim,)),
        BatchNormalization(),
        Dropout(0.3),
        Dense(256, activation='relu', kernel_regularizer=l2(l2_alpha)),
        BatchNormalization(),
        Dropout(0.3),
        Dense(128, activation='relu', kernel_regularizer=l2(l2_alpha)),
        BatchNormalization(),
        Dropout(0.3),
        Dense(1, activation='sigmoid')
    ])
